...
<table align="center"
 ...
 <?php 
  include "config.php";
  include "antisql.php";
  $nome = antisql($conexao,$_POST["txtNome"]);  
  $sql = "SELECT * FROM alunos WHERE nome LIKE '%$nome%' ORDER BY matricula";
...
?>
  <tr>
    <td colspan="7" align="center">Dados n&atilde;o encontrados</td>
  </tr>
<?php 
}
?>
